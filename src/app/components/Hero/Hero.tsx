...
const Hero = () => {
  return (
    <section>
      <div className="flex flex-col bg-cover h-screen bg-no-repeat justify-start items-start  bg-[url(/images/p2.webp)]">
        <h1 className="text-4xl md:texl-5xl lg:text-6xl font-bold italic mb-4 mt-40 ml-4">
